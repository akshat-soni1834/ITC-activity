total_runs_scored = int(input("Enter total runs scored by the team: "))
total_overs_faced = int(input("Enter total overs faced by the team: "))
total_runs_conceded = int(input("Enter total runs conceded by the team's opponents: "))
total_overs_bowled = int(input("Enter total overs bowled by the team's opponents: "))
